...
const BEAVER_ONLY_PROMPT = [
  ...
  "- Ringed tail, black facial mask, black/light banded or striped pattern, pointed snout, small upright ears",
  "- Note: raccoons in this dataset may be foraging near stream/water edges (not necessarily climbing).",
